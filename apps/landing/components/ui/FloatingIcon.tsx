...
// Floating Icon Component - Generic and Reusable
export function FloatingIcon({
  ...
  floatDuration = 3,
  rotation = 0,
  dropShadowColor = 'rgba(0, 0, 255, 0.35)',
}) {
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        rotate: rotation,
        filter: `drop-shadow(0 16px 24px ${dropShadowColor})`,
      }}
...
// Pre-made Icon Components for convenience
export function TypeScriptIcon({ className = '', ...props }) {
  return (
    <FloatingIcon
      className={`size-12 ${className}`}
      dropShadowColor="rgba(49, 120, 198, 0.35)"
      {...props}
    >
      <svg
...
export function RustIcon({ className = '', ...props }) {
  return (
    <FloatingIcon
      className={`size-16 ${className}`}
      dropShadowColor="rgba(160, 79, 18, 0.35)"
      {...props}
    >
      <svg
        className="w-full h-full"
...
export function BitcoinIcon({ className = '', ...props }) {
  return (
    <FloatingIcon
      className={`size-14 ${className}`}
      dropShadowColor="rgba(247, 147, 20, 0.35)"
      {...props}
    >
      <svg
        className="w-full h-full"
...
export default function FloatingIconsDemo() {
  return (
    <div className="relative w-full h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 overflow-hidden">
      <div className="max-w-4xl mx-auto h-full flex flex-col items-center justify-center gap-4 px-4">
        <h1 className="text-5xl font-bold text-white text-center mb-4">
          Floating Icons Demo
        </h1>
        <p className="text-gray-300 text-center max-w-2xl">
          Move your mouse around to see the parallax effect! These icons float
          and follow your cursor with different speeds.
        </p>
      </div>
